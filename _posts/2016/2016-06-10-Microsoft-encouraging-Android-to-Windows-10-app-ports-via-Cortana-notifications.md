...
{% include post/imagecaption.html url="/images/android-request.jpg" description="source: Windows Central" %}
{% include post/imagecaption.html url="/images/android-request(mspoweruser).png" description="source: MSPowerUser" %}
