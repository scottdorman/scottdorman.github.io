...
{% include post/imagecaption.html url="/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/android-request.jpg" description="source: Windows Central" %}

{% include post/imagecaption.html url="/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/android-request(mspoweruser).png" description="source: MSPowerUser" %}
