...
{% include post/imagecaption.html url="/images/posts/android-request.jpg" description="source: Windows Central" %}
{% include post/imagecaption.html url="/images/posts/android-request(mspoweruser).png" description="source: MSPowerUser" %}
