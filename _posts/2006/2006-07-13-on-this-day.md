...
```javascript
var returnString = "<SPAN class='\"on-this-day\"'>On this day: #Wikipedia# á #HistoryChannel# á #NYTimes# á #BBC# á #IMDB# á #Reference# á #Britannica# á #BrainyHistory# á #DailyBleed# á #OnThisDay#</SPAN>";
```
