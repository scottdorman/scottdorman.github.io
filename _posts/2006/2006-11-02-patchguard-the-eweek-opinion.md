...
In the article, Larry reiterates some of the points I made in my [post]({% post_url 2006/2006-10-30-95540 %} "Kernel Patch Protection aka "PatchGuard"") on PatchGuard a few days ago, namely:
