...
date: 8/30/2008 12:01:28 PM
---

Not too long ago I [mentioned](http://geekswithblogs.net/sdorman/archive/2008/08/19/stylecop-4.3-released.aspx) that [StyleCop](http://code.msdn.microsoft.com/sourceanalysis) 4.3 had been released and that the SDK documentation would be out shortly. The wait is over and the SDK documentation is now [available](https://code.msdn.microsoft.com/Release/ProjectReleases.aspx?ProjectName=sourceanalysis&ReleaseId=1425).
