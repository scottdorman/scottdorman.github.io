...
![image](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/image-2.png) The Threads window provides a few useful tricks of it's own that you might not be aware of. The first three tricks are available from the context menu.
...
![](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/080107-2004-neatnewmult2-3.png)  
...
![](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/image-5.png) 
...
![](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/080107-2004-neatnewmult1-3.png) 
...
![](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/image140-3.png)
