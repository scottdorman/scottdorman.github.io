...
![](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/1-2.png) ![](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/2-2.png) ![](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/5-2.png) 
