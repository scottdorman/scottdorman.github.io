...
![](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/1_2.png) ![](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/2_2.png) ![](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/5_2.png) 
