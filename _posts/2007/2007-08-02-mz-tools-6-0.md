...
![](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/result-window1-3.gif)
...
![](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/code-template-selection1-1.gif) 
...
![](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/sort-code-elements1-1.gif)  
...
![](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/control-explorer1-3.gif)
...
![](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/statistics1-1.gif)
